# Generated by Django 5.1.1 on 2024-11-04 03:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documentos_criados', to=settings.AUTH_USER_MODEL)),
                ('equipe', models.ManyToManyField(blank=True, related_name='equipes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
